...
def test_channels_create_public_success():
    ...
    "owner_members" : [{"u_id" : login['u_id'], "name_first" : "New", "name_last" : "Owner", 'profile_img_url': ''}],
    "all_members" : [{"u_id" : login['u_id'], "name_first" : "New", "name_last" : "Owner", 'profile_img_url': ''}]}
